...
public class ListUsuarioActivity extends Activity{
	private crudUsuarioDAO dbUsu=new crudUsuarioDAO(this);
	private String titulo;
	private String variavel;
	private String myGrupo;
	private int inteiro;
	...
	public void pegaGrupo(){
		...
		if(extras!=null){
			myGrupo=extras.getString("grupo");
	...
	public void listaUsuario(){
		...
		if(cursor.moveToFirst()){
			do{
				...
				idList.setText(txt);
				nomeList.setText(variavel+" "+consulta.getNome().toString());
				...
				myLayout.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
							...
							runActivity(com.example.fitnessdroid.ExerciciosActivity.class, "listar", var,"grupo",myGrupo);
	...
	public void runActivity(Class<?> class1,String receptor1,String var1,String receptor2,String var2){
		//var=variavel;
		Intent intent=new Intent(this,class1);
		intent.putExtra(receptor1, var1);
		intent.putExtra(receptor2, var2);
