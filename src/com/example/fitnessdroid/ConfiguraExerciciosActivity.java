...
public class ConfiguraExerciciosActivity extends Activity {
	...
	public void abrePeitorais(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","1");
	...
	public void abreDorsais(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","2");
	...
	public void abreBiceps(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","3");
	...
	public void abreTriceps(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","4");
	...
	public void abreDeltoides(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","5");
	...
	public void abreAbdomen(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","6");
	...
	public void abreAnteriores(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","7");
	...
	public void abrePosteriores(){
		...
		public void onClick(View v) {
			...
			runEnviar(com.example.fitnessdroid.FormManagerExercicesActivity.class,"grupo","8");
