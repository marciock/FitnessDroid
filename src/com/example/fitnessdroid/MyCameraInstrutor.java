...
public class MyCameraInstrutor extends Activity {
	...
	public void runActivity(Class<?> class1,String receptor1,String var1){
		...
		intent.putExtra("individuo","com.example.fitnessdroid.FormInstrutorActivity");
	...
	public void clicaCamera(){
		...
		public void enviaBitmap(){
			...
			Intent intent=new Intent(getBaseContext(),com.example.fitnessdroid.FormInstrutorActivity.class);
